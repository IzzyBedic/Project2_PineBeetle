...
### Scatterplot matrix: Let's see if there's any multicollinearity. Observe how all the variables look graphed with each other!
...
ggpairs(pine_fact_tbl, columns = c("DeadDist", 
        ...
        title = "Factors related to Pine Beetle infestation in forests as they relate to each other when a tree within 1/20th acres is infested vs not")
```
